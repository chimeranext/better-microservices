...
hello@chimeranext.dev) — intellectual author of vision-core.
Licensed and published by ChimeraNext Shared Services LLC.

vision-core is licensed under the Business Source License agreement below.

vision-core occasionally includes source code that is derived from or bundles
...
vision-core BUSINESS SOURCE LICENSE AGREEMENT
...
2031-06-01 (five years from the first publicly available distribution of the Licensed Work).
