...
andres@dojocoding.io) — intellectual author of filing-core.
Licensed and published by ChimeraNext Shared Services LLC.

filing-core is licensed under the Business Source License agreement below.

filing-core occasionally includes source code that is derived from or bundles
...
filing-core BUSINESS SOURCE LICENSE AGREEMENT
...
filing-core Version 0.0.1 or later.
...
2030-04-16 (four years from the first publicly available distribution of the Licensed Work).
