...
hello@chimeranext.dev) — intellectual author of agentic-core.
Licensed and published by ChimeraNext Shared Services LLC.

agentic-core is licensed under the Business Source License agreement below.

agentic-core occasionally includes source code that is derived from or bundles
...
agentic-core BUSINESS SOURCE LICENSE AGREEMENT
...
2031-03-25 (five years from the first publicly available distribution of the Licensed Work).
